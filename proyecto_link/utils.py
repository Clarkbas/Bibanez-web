...
preview = "https://www.linkedin.com/in/basti%C3%A1n-ib%C3%A1%C3%B1ez-a52667194/"

_meta = [
    {"name": "og:type", "content": "website"},
    {"name": "og:image", "content": preview},
    {"name": "twitter:card", "content": "summary_large_image"},
    {"name": "twitter:site", "content": "@Bibanez"}
]

# Index

index_title = "Bibanez | cocinando con codigos"
index_description = "Hola, mi nombre es Bastián Ibáñez. Soy un programador full stack java aprendiendo de python, SQL y más."
...
courses_title = "Bibanez | Cursos gratis  que me han ayudado de programación"
